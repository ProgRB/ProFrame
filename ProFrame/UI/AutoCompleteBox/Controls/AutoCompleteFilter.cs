...
namespace System.Windows.Controls
{
    ...
    internal static class AutoCompleteSearch
    {
        ...
        public static Func<string, string, bool> GetFilter(AutoCompleteFilterMode FilterMode)
        {
            switch (FilterMode)
            {
        ...
        {
            return value.IndexOf(text, 1, StringComparison.CurrentCultureIgnoreCase)>-1;
        }
        ...
        {
            return value.IndexOf(text, 1, StringComparison.CurrentCulture)>-1;
        }
        ...
        {
            return value.IndexOf(text, 1, StringComparison.OrdinalIgnoreCase)>-1;
        }
        ...
        {
            return value.IndexOf(text, 1, StringComparison.Ordinal)>-1;
        }
